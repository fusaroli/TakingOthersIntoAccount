...
naive_diagnosis_m <- add_criterion(naive_diagnosis_m,criterion=c("waic","loo","bayes_R2"), file = "models/naive_diagnosis_m")
...
weighted_diagnosis_m <- add_criterion(weighted_diagnosis_m,criterion=c("waic","loo","bayes_R2"), file = "models/weighted_diagnosis_m")
...
circular_noI_diagnosis_m <- add_criterion(circular_noI_diagnosis_m,criterion=c("waic","loo","bayes_R2"), file = "models/circular_noI_diagnosis_m")
...
circular_diagnosis_m <- add_criterion(circular_diagnosis_m,criterion=c("waic","loo","bayes_R2"), file = "models/circular_diagnosis_m")
...
glm_diagnosis_m = brm(glm_diagnosis_f,
             ...
             chains = N_CORES, cores = N_CORES, iter = ITER,
             control = STAN_CONTROL)
glm_diagnosis_m <- add_criterion(glm_diagnosis_m,criterion=c("waic","loo","bayes_R2"), file = "models/glm_diagnosis_m")
...
heuristic_diagnosis_m <- add_criterion(heuristic_diagnosis_m,
                                     criterion=c("waic","loo","bayes_R2"), file = "models/heuristic_diagnosis_m")
...
circular_TasitTotal_m <-
  add_criterion(
    ...
    file = "models/circular_TasitTotal_m"
  )
...
circular_TasitTotal_IQ_m <-
  add_criterion(
    circular_TasitTotal_IQ_m,
    criterion = c("waic", "loo", "bayes_R2"),
    file = "models/circular_TasitTotal_IQ_m"
  )
...
circular_Hallucinations_m <- add_criterion(circular_Hallucinations_m,criterion=c("waic","loo","bayes_R2"), file = "models/circular_Hallucinations_m")
...
circular_Delusions_m <- add_criterion(circular_Delusions_m,criterion=c("waic","loo","bayes_R2"), file = "models/circular_Delusions_m")
...
circular_Bizarre_m <- add_criterion(circular_Bizarre_m,criterion=c("waic","loo","bayes_R2"), file = "models/circular_Bizarre_m")
...
circular_FormalThought_m <- add_criterion(circular_FormalThought_m,criterion=c("waic","loo","bayes_R2"), file = "models/circular_FormalThought_m")
...
circular_Flattening_m <- add_criterion(circular_Flattening_m,criterion=c("waic","loo","bayes_R2"), file = "models/circular_Flattening_m")
...
circular_Alogia_m = brm(circular_Alogia_f,
               ...
               sample_prior = TRUE,
               family = "bernoulli", 
               file = "models/circular_Alogia_m",
               chains = N_CORES, cores = N_CORES, iter = ITER, refresh=20,
               control = STAN_CONTROL)

circular_Alogia_m <- add_criterion(circular_Alogia_m,criterion=c("waic","loo","bayes_R2"), file = "models/circular_Alogia_m")
# Avolition model
...
circular_Avolition_m <- add_criterion(circular_Avolition_m,criterion=c("waic","loo","bayes_R2"), file = "models/circular_Avolition_m")
...
circular_Anhedonia_m <- add_criterion(circular_Anhedonia_m,criterion=c("waic","loo","bayes_R2"), file = "models/circular_Anhedonia_m")
...
circular_Attention_m <- add_criterion(circular_Attention_m,criterion=c("waic","loo","bayes_R2"), file = "models/circular_Attention_m")
...
circular_PSP_m <- add_criterion(circular_PSP_m,criterion=c("waic","loo","bayes_R2"), file = "models/circular_PSP_m")
...
circular_nopooling_m <- add_criterion(circular_nopooling_m,criterion=c("waic","loo","bayes_R2"), file = "models/circular_nopooling_m")
...
weighted_schizophrenia_m <- add_criterion(weighted_schizophrenia_m,criterion=c("waic","loo","bayes_R2"), file = "models/weighted_schizophrenia_m")
...
weighted_controls_m <- add_criterion(weighted_controls_m,criterion=c("waic","loo","bayes_R2"), file = "models/weighted_controls_m")
...
circular_noI_controls_m <- add_criterion(circular_controls_noI_m,criterion=c("waic","loo","bayes_R2"), file = "models/circular_noI_controls_m")
...
circular_noI_schizophrenia_m <- add_criterion(circular_noI_schizophrenia_m,criterion=c("waic","loo","bayes_R2"), file = "models/circular_noI_schizophrenia_m")
...
circular_schizophrenia_m = brm(circular_f,
               ...
               sample_prior = TRUE,
               family = "bernoulli",
               file = "models/circular_schizophrenia_m2",
               chains = N_CORES, cores = N_CORES, iter = ITER, refresh = 20,
               control = STAN_CONTROL)
circular_schizophrenia_m <- add_criterion(circular_schizophrenia_m,criterion=c("waic","loo","bayes_R2"), file = "models/circular_schizophrenia_m2")
...
circular_controls_m = fit_brm(circular_f,
               ...
               chains = N_CORES, cores = N_CORES, iter = ITER,
               control = STAN_CONTROL)
circular_controls_m <- add_criterion(circular_controls_m,criterion=c("waic","loo","bayes_R2"), file = "models/circular_controls_m")
...
glm_schizophrenia_m = brm(glm_f,
             ...
             chains = N_CORES, cores = N_CORES, iter = ITER,
             control = STAN_CONTROL)
glm_schizophrenia_m <- add_criterion(glm_schizophrenia_m,criterion=c("waic","loo","bayes_R2"), file = "models/glm_schizophrenia_m")
...
glm_controls_m = brm(glm_f,
             ...
             chains = N_CORES, cores = N_CORES, iter = ITER,
             control = STAN_CONTROL)
glm_controls_m <- add_criterion(glm_controls_m,criterion=c("waic","loo","bayes_R2"), file = "models/glm_controls_m")
...
heuristic_schizophrenia_m = brm(heuristic_f,
             ...
             prior = heuristic_prior,
             sample_prior = TRUE,
             file="models/Heuristic_schizophrenia_m",
             chains = N_CORES, cores = N_CORES, iter = ITER,
             control = STAN_CONTROL)
heuristic_schizophrenia_m <- add_criterion(heuristic_schizophrenia_m,
                                     criterion=c("waic","loo","bayes_R2"), file = "models/heuristic_schizophrenia_m")
...
heuristic_controls_m = brm(heuristic_f,
             ...
             prior = heuristic_prior,
             sample_prior = TRUE,
             file="models/Heuristic_controls_m",
             chains = N_CORES, cores = N_CORES, iter = ITER,
             control = STAN_CONTROL)
heuristic_controls_m <- add_criterion(heuristic_controls_m,
                                     criterion=c("waic","loo","bayes_R2"), file = "models/heuristic_controls_m")
```
...
for (participant in unique(full_data$Subject)){
  ...
  naive_participant_m <- add_criterion(naive_participant_m, 
                                       criterion=c("waic","loo","bayes_R2"), file=paste0("models/ByParticipant/Naive_S",participant,"_m"))
  ...
  weighted_participant_m <- add_criterion(weighted_participant_m,
                                          criterion=c("waic","loo","bayes_R2"), file=paste0("models/ByParticipant/Weighted_S",participant,"_m"))
  ...
  circular_noI_participant_m <- add_criterion(circular_noI_participant_m,
                                              criterion=c("waic","loo","bayes_R2"),file=paste0("models/ByParticipant/CircularNoI_S",participant,"_m"))
  ...
  circular_participant_m <- add_criterion(circular_participant_m,
                                          criterion=c("waic","loo","bayes_R2"), file=paste0("models/ByParticipant/Circular_S",participant,"_m"))
  ...
  glm_participant_m <- add_criterion(glm_participant_m,
                                     criterion=c("waic","loo","bayes_R2"), file = paste0("models/ByParticipant/GLM_S",participant,"_m"))
  ...
  heuristic_participant_m <- add_criterion(heuristic_participant_m,
                                     criterion=c("waic","loo","bayes_R2"), file = paste0("models/ByParticipant/Heuristic_S",participant,"_m"))
...
mAlogia <- add_criterion(mAlogia,criterion="loo",file="models/mAlogia")
...
mAlogiamo <- add_criterion(mAlogiamo, criterion="loo", file="models/mAlogiamo")
...
mAllmoPLUS <- add_criterion(mAllmoPLUS, criterion="loo", file="models/mAllmoPLUS")
## Compare
...
ggsave(ForestWothers, file="ForestWothers.svg", width=9,height=9)+ guides(fill=FALSE)

ForestWothersLow <- ggplot(xxx, aes(x = wOthersLow, y = ID, group=ID,fill=Diagnosis)) +
  geom_density_ridges(rel_min_height = 0.01)+theme_classic()+ guides(fill=FALSE)
ggsave(ForestWothersLow, file="ForestWothersLow.svg", width=9,height=9)

ForestWothersHigh <- ggplot(xxx, aes(x = wOthersHigh, y = ID, group=ID,fill=Diagnosis)) +
  geom_density_ridges(rel_min_height = 0.01)+theme_classic()+ guides(fill=FALSE)
ggsave(ForestWothersHigh, file="ForestWothersHigh.svg", width=9,height=9)
ForestbConfidence <- ggplot(xxx, aes(x = bConfidence, y = ID, group=ID,fill=Diagnosis)) +
  geom_density_ridges(rel_min_height = 0.01)+theme_classic()+ guides(fill=FALSE)
ggsave(ForestbConfidence, file="ForestbConfidence.svg", width=9,height=9)
...
ggsave(file="ForestAll.svg", width=9,height=15)
```
...
edges <- read_delim("data/network_edges.csv",delim=",") %>% select(
...
nodes <- read_delim("data/network_nodes.csv",delim=",")
