...
hypothesis(circular_IQ_m, "wSelf_TasitTotal < 0")
hypothesis(circular_IQ_m, "wOthers_TasitTotal > 0")
hypothesis(circular_IQ_m, "aSelf_TasitTotal < 0")
hypothesis(circular_IQ_m, "aOthers_TasitTotal > 0")
...
mycolors <- colorRampPalette(brewer.pal(11, "RdYlGn"))(16)
...
mycolors <- colorRampPalette(brewer.pal(11, "RdYlGn"))(7)
